...
const en = {
  ...
  flavourNotes: {
    classic: 'Pure baked Antonovka apple',
    berry: 'Apple with blueberry & cranberry',
    cinnamon: 'Apple with cinnamon',
    cherry: 'Apple with sour cherry',
    blueberry: 'Apple with wild blueberry',
    lingonberry: 'Apple with forest lingonberry',
    blackcurrant: 'Apple with black currant',
    pine: 'Apple with pine nuts',
    cranberry: 'Apple with cranberry',
    apple: 'Classic apple zephyr',
    vanilla: 'Soft vanilla zephyr',
    chocolate: 'Apple zephyr in dark chocolate',
...
const ru: Partialised = {
  ...
  flavours: {
    ...
    cinnamon: 'С корицей',
    cherry: 'С вишней',
    blueberry: 'С голубикой',
    lingonberry: 'С брусникой',
    blackcurrant: 'С чёрной смородиной',
    pine: 'С кедровым орехом',
    cranberry: 'С клюквой',
    apple: 'Яблоко антоновка',
    vanilla: 'Ванильный',
    chocolate: 'В тёмном шоколаде',
    assorted: 'Ассорти',
  },
  flavourNotes: {
    classic: 'Чистое печёное яблоко антоновка',
    berry: 'Яблоко с голубикой и клюквой',
    cinnamon: 'Яблоко с корицей',
    cherry: 'Яблоко с кислой вишней',
    blueberry: 'Яблоко с лесной голубикой',
    lingonberry: 'Яблоко с лесной брусникой',
    blackcurrant: 'Яблоко с чёрной смородиной',
    pine: 'Яблоко с кедровыми орехами',
    cranberry: 'Яблоко с клюквой',
    apple: 'Классический яблочный зефир',
    vanilla: 'Мягкий ванильный зефир',
    chocolate: 'Яблочный зефир в тёмном шоколаде',
...
const lv: Partialised = {
  ...
  flavours: {
    ...
    berry: 'Ogu mikss',
    cinnamon: 'Ar kanēli',
    cherry: 'Ar skābajiem ķiršiem',
    blueberry: 'Ar mellenēm',
    lingonberry: 'Ar brūklenēm',
    blackcurrant: 'Ar upenēm',
    pine: 'Ar ciedru riekstiem',
    cranberry: 'Ar dzērvenēm',
    apple: 'Antonovka ābols',
    vanilla: 'Vaniļas',
    chocolate: 'Tumšajā šokolādē',
    assorted: 'Asorti',
  },
  flavourNotes: {
    classic: 'Tīrs cepts Antonovka ābols',
    berry: 'Ābols ar mellenēm un dzērvenēm',
    cinnamon: 'Ābols ar kanēli',
    cherry: 'Ābols ar skābajiem ķiršiem',
    blueberry: 'Ābols ar meža mellenēm',
    lingonberry: 'Ābols ar meža brūklenēm',
    blackcurrant: 'Ābols ar upenēm',
    pine: 'Ābols ar ciedru riekstiem',
    cranberry: 'Ābols ar dzērvenēm',
    apple: 'Klasiskais ābolu zefīrs',
    vanilla: 'Mīksts vaniļas zefīrs',
    chocolate: 'Ābolu zefīrs tumšajā šokolādē',
